...
คำสั่งสำหรับนำโมเดล YOLO ที่เทรนเสร็จแล้วมารัน Inference บนการ์ดจอ (GPU) แบบ **Batch Processing** เพื่อตรวจจับและสร้างไฟล์ Annotation `.json` ให้กับรูปภาพใหม่ทั้งโฟลเดอร์โดยอัตโนมัติ
...
* **Standard Annotation JSON Output**: สร้างไฟล์ `.json` ที่มีโครงสร้างมาตรฐาน พร้อมเปิดตรวจทานและแก้ไขบน Web Reviewer ได้ในคลิกเดียว
